...
public class SecurityUtil {
	...
	public static Long getMerchantId() {
		HttpServletRequest request = ((ServletRequestAttributes) (RequestContextHolder.currentRequestAttributes()))
				.getRequest();
		// jsonToken = request.getHeader("authorization");
		String jsonToken = "Bearer eyJtZXJjaGFudElkIjoxNzIzMjczNjU4NDQ1NTUzNjY1LCJ1c2VyX25hbWUiOiLpmL/lpKfmkpIiLCJtb2JpbGUiOiIxMjMifQ==";
