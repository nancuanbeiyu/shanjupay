...
public interface TenantService {
     ...
     * @return
     */
    PageVO<TenantDTO> queryTenants(TenantQueryDTO tenantQuery, Integer pageNo, Integer pageSize, String sortBy, String order) ;
...
////////////////////套餐管理start/////////////////////
     ...
     * @return
     */
    PageVO<AccountDTO> queryAccount(AccountQueryDTO accountQuery, Integer pageNo, Integer pageSize, String sortBy, String order);
